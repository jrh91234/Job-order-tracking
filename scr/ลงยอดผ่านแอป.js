/**
 * Web App ของหน้าลงยอด / Job Monitor — โปรเจกต์ Apps Script ชื่อ "KPI" (ผูกกับชีต)
 *
 * ระบบนี้มี Apps Script 2 โปรเจกต์แยกกัน อีกตัวคือบันทึกเหตุการณ์ (`gas_sync_incidents.js`)
 * ซึ่งเป็นโปรเจกต์แยกอิสระคนละตัวและมี URL คนละอัน **ห้ามเอามารวมกัน**
 * เพราะทั้งคู่มี doPost เป็นของตัวเอง และ Apps Script จะให้ตัวที่โหลดทีหลังทับตัวแรกเงียบ ๆ
 *
 * รายละเอียดทั้งหมด (URL, ชื่อโปรเจกต์, วิธีหาเมื่อลืม, ประวัติปัญหา): docs/apps-script-map.md
 */
